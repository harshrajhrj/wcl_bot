...
module.exports = {
    ...
    execute: async (message, args) => {
        ...
        if (message.author.id === '531548281793150987') {
            ...
            const resource = await fetch(`https://sheets.googleapis.com/v4/spreadsheets/1XYbVO9LQ-gGzspqdmsQeHHlJPECbt4EO_jqXpeLzLGU/values/Schedules!A2:J?majorDimension=ROWS&key=AIzaSyDUq4w3z35sS28BKWLdXSh32hlwUDDaD1Y`, options);
