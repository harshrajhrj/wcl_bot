...
module.exports = {
    ...
    explanation: `Ex: bcl deleteweek CS wk5\nwhere CS is Champions Division\nwk5 is Week 5\n\nbcl deleteweek abb wk5\ndeletes wk5 for a particular abb\n\nWeek code/range
    'WK1': 'WK1',
    'WK2': 'WK2',
    'WK3': 'WK3',
    'WK4': 'WK4',
    ...
    execute: async (message, args) => {
        ...
        const options = resources.DIVISION_ABBS;
